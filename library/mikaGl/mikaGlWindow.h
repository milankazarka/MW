...
typedef struct mikaGlWindowDelegate {
  ...
  void		*(*onButtonMotion)( void *windowData, struct eventButton *event );
...
class mikaGlWindow {
  public:
    ...
    int eventButtonMotion( int x, int y, int id );
    
    virtual void onEventButtonDown( int x, int y, int id );
    virtual void onEventButtonRelease( int x, int y, int id );
    virtual void onEventButtonMotion( int x, int y, int id );
};
